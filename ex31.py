...
if door == 1:
    ...
    print("1. Расскажу Ктулху про топи Сибири.")
    ...
    if insanity == 1 or insanity == 2:
        ...
        print("Безумие охватило тебя, и ты упал в ближайший бассейн с гнилью.")
        print("Просто прекрасно!")

else:
    print("Безумие охватило тебя, и ты разорвал себе лицо. Отличная работа!")
